...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-pearl-gradient flex items-center justify-center p-8">
        <div className="w-full max-w-[400px] text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[var(--color-emerald-50)] mx-auto mb-6">
            <Stethoscope className="h-8 w-8 text-[var(--color-emerald-600)]" strokeWidth={1.8} />
          </div>
          <h1 className="text-2xl font-bold font-[family-name:var(--font-display)] text-[var(--color-pearl-900)] mb-2">
            Check your email
          </h1>
    ...
    <div className="min-h-screen bg-pearl-gradient flex">
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-8">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mt-6">
            <Button variant="outline" size="lg" className="w-full text-sm gap-2" onClick={handleGoogleSignUp}>
